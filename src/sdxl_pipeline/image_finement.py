...
class SDXLControlNetInpainter:
    ...
    def get_canny_map(self, image_pil, k_size= 9, sigma=0.33):
    ...
    def post_process_mask(self, mask_np, dilation_iterations=4, blur_kernel=9):
        """
        对掩码进行后处理：扩张 + 高斯模糊
        """
        # 扩张 - 让掩码往外走一点，包住物体的边缘
...
if __name__ == "__main__":
    def load_model(weight=r"D:\MM\MultiMod\u2net.pth"):
        net = U2NET(3, 1)
    ...
    # 格式：{ r"图片路径": "主体描述" }
    # tasks = {
    #     r"D:\MM\dackel.jpg": "A white puppy",
    #     r"D:\MM\pen.jpg":    "A black pen",
    #     r"D:\MM\fish.jpg":   "A green fish",
    #     r"D:\MM\flower.jpg": "A red flower",
    # }
    
    
    # 更加精细化的配置
    tasks = {
        r"C:\Users\jytna\OneDrive - TUM\MM\dackel.jpg": {
            "subject": "A white puppy",
            "n_prompt": "brown, dark fur, low quality" 
        },
        r"C:\Users\jytna\OneDrive - TUM\MM\pen.jpg": {
            "subject": "A black pen",
            "n_prompt": "silver, gold, brown, blurry"
        },
        r"C:\Users\jytna\OneDrive - TUM\MM\fish.jpg": {
            "subject": "A green fish",
            "n_prompt": "red, orange, distorted"
        },
        r"C:\Users\jytna\OneDrive - TUM\MM\flower.jpg": {
            "subject": "A red flower",
            "n_prompt": "blue petals, blue, low quality"
        },
    }
    ...
    test_scales = [0.3, 0.8, 1.0]
    output_dir = "image_refinement_4"
    os.makedirs(output_dir, exist_ok=True)

    # 开始迭代
    for img_path, info in tasks.items():            
        base_name = os.path.splitext(os.path.basename(img_path))[0]

        subject = info["subject"]
        current_n_prompt = info["n_prompt"] 
        ...
        for scale in test_scales:
            ...
            result = inpainter.generate(
                ...
                negative_prompt=current_n_prompt, 
                assets=assets,
                control_scale=scale
            )
